  ...
  const footerLinks = [
    {
      title: "Products",
      links: [
        { name: "Face Recognition", href: "/image-save" },
        { name: "Object Detection", href: "/object-detection" },
        { name: "Email Management", href: "/email" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-xs">
              Your smart personal assistant that combines AI with Google services to enhance productivity and simplify your digital life.
            </p>
